...
%view(-50,15)
ax = gca;
%exportgraphics(ax,'ActivePhaseSpaceSwith1IC.png','Resolution',300)
...
set(gca, 'FontSize', 12)
ax = gca;
% exportgraphics(ax,'RelativeErrorsX1Swith1IC.png','Resolution',300)
%
figure
plot(tsim,er2), grid;
...
set(gca, 'FontSize', 12)
ax = gca;
% exportgraphics(ax,'RelativeErrorsX2Swith1IC.png','Resolution',300)
% 
figure
plot(tsim,er3), grid;
...
set(gca, 'FontSize', 12)
ax = gca;
% exportgraphics(ax,'RelativeErrorsX3Swith1IC.png','Resolution',300)
%           
%%
...
set(gca, 'FontSize', 16)
ax = gca;
% exportgraphics(ax,'VariableStateSwith1IC.png','Resolution',300)
%
%%
...
%
%% Save state variables
% savefile1 = 'y1MasterLyapICS6.mat';
% savefile2 = 'y2MasterLyapICS6.mat';
% savefile3 = 'y3MasterLyapICS6.mat';
% % 
% save(savefile1, 'v1');
% save(savefile2, 'v2');
% save(savefile3, 'v3');
% %
% savefile4 = 'y1SlaveLyapICS6.mat';
% savefile5 = 'y2SlaveLyapICS6.mat';
% savefile6 = 'y3SlaveLyapICS6.mat';
% % 
% save(savefile4, 'w1');
% save(savefile5, 'w2');
% save(savefile6, 'w3');
% %
% savefile7 = 'Error1LyapICS6.mat';
% savefile8 = 'Error2LyapICS6.mat';
% savefile9 = 'Error3LyapICS6.mat';
% % 
% save(savefile7, 'e1');
% save(savefile8, 'e2');
% save(savefile9, 'e3');
...
% savefile10 = 'timesimICS6.mat';
% save(savefile10, 'tsim');
% %
% % Save the iterations to graphs
% savefile11 = 'IterLyap1ICS6.mat';
