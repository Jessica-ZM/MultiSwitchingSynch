...
load('C:\Users\jessi\Documents\Estancia\MastersNumericalIntegration\sm1IC3','s1');
load('C:\Users\jessi\Documents\Estancia\MastersNumericalIntegration\sm2IC3','s2');
load('C:\Users\jessi\Documents\Estancia\MastersNumericalIntegration\sm3IC3','s3');
...
% sol = bvp4c(@odeRossler, @bcRossler, SOLin1);
%%
...
for i = 1:n
    ref1 = spline(tsim,s1,time(i));
    ref2 = spline(tsim,s2,time(i));
    ref3 = spline(tsim,s3,time(i));
    e1(i) =  ref1 - y(1,i);
    e2(i) =  ref2 - y(2,i);
    e3(i) =  ref3 - y(3,i);
    y1m(i) = ref1;
...
%view(-25,9)
ax = gca;
%exportgraphics(ax,'BestPhaseSpaceSwith2IC2.png','Resolution',300)
%
%%
figure
tiledlayout(3,1)
...
grid 
legend('x_1(y_3+z_2)','w_1')
set(gca, 'FontSize', 16)
% 2 plot
nexttile
plot(time,y2m,'-m',time,y(2,:),'g--','linewidth',1)
grid 
legend('x_3(y_2+z_3)', 'w_2')
set(gca, 'FontSize', 16)
% 3 plot
nexttile
...
figure
plot(time,er1), grid;
title('Relative error e_{1321}');
xlabel('time')
set(gca, 'FontSize', 12)
ax = gca;
%exportgraphics(ax,'RelativeErrorsX1Swith2IC2.png','Resolution',300)
% 2 plot
figure
plot(time,er2), grid;
title('Relative error e_{3232}');
xlabel('time')
set(gca, 'FontSize', 12)
ax = gca;
%exportgraphics(ax,'RelativeErrorsX2Swith2IC2.png','Resolution',300)
% 3 plot
figure
plot(time,er3), grid;
title('Relative error e_{2113}');
xlabel('time')
set(gca, 'FontSize', 12)
ax = gca;
%exportgraphics(ax,'RelativeErrorsX3Swith2IC2.png','Resolution',300)
%
%%
figure
...
%%
% save error
savefile1 = 'Error1IC3SV1.mat';
savefile2 = 'Error2IC3SV1.mat';
savefile3 = 'Error3IC3SV1.mat';
%
save(savefile1, 'e1');
save(savefile2, 'e2');
save(savefile3, 'e3');
%
% save control
savefile4 = 'Controlu1IC3SV1.mat';
savefile5 = 'Controlu2IC3SV1.mat';
savefile6 = 'Controlu3IC3SV1.mat';
%
save(savefile4, 'u1');
save(savefile5, 'u2');
save(savefile6, 'u3');
...
savefile7 = 'y1SlaveIC3SV1.mat';
savefile8 = 'y2SlaveIC3SV1.mat';
savefile9 = 'y3SlaveIC3SV1.mat';
%
y1s = y(1,:);
y2s = y(2,:);
y3s = y(3,:);
...
savefile10 = 'TimeSynchIC3SV1.mat';
save(savefile10, 'time');
% 
% save state variables of master system
savefile11 = 'y1MasterIC3SV1.mat';
savefile12 = 'y2MasterIC3SV1.mat';
savefile13 = 'y3MasterIC3SV1.mat';
%
save(savefile11, 'y1m');
save(savefile12, 'y2m');
save(savefile13, 'y3m');
%
% save iterations
savefile14 = 'IterSynchIC3SV1.mat';
